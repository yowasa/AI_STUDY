# import jieba
# import os
# basedir = "/Users/yowasa/Documents/THUCNews/"
# dir_list = ['体育', '家居', '房产', '时尚', '星座', '社会', '股票', '娱乐', '彩票', '教育', '时政', '游戏', '科技', '财经']
# ##生成fastext的训练和测试数据集
#
...
# classifier.save_model('fasttext.model.bin')
# print('训练完成！')

import fasttext

classifier = fasttext.load_model('fasttext.model.bin')
